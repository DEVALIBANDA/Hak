...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_Black/master/File_Bot/commands.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_Black/master/File_Bot/Reply.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jack1eljoker1/Files_Black/master/File_Bot/games.lua") 
...
sudo_users = {SUDO,1424388256,1488653639,1317966118}   
...
if hash or SudoBot(msg) or DevblackW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevblackW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevblackW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevblackW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevblackW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevblackW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevblackW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1424388256) then  
var = true  
elseif tonumber(user_id) == tonumber(1488653639) then
var = true 
elseif tonumber(user_id) == tonumber(1317966118) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@V_P_E")  
...
function plugin_black(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.black and msg then
pre_msg = plugin.black(msg)
end
end
end
...
if DevblackW(msg) then
local bl = '❍ اهلا عزيزي آلمـطـور\n❍ آنت آلمـطـور آلآسـآسـي للبوت\nــــــــــــــــــــــ❍ـــــــــــــــــــــ\n❍ تسـتطـيع‌‏ آلتحگم باوامر البوت\n❍ من خلاال الكيبورت خاص بك\n❍ قناة سورس البوت [اضغط هنا](t.me/BLACK_TEAM_4)'
local keyboard = {
{'المبرمج جاك','المبرمج الجوكر'},
{'المبرمج ادهم'},
{'الاحصائيات'},
...
if not DevblackW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevblackW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل' and DevblackW(msg) then  
...
if text == 'تعطيل التواصل' and DevblackW(msg) then  
...
if text == 'تفعيل البوت خدمي' and DevblackW(msg) then  
...
if text == 'تعطيل البوت خدمي' and DevblackW(msg) then  
...
if text == 'ضع كليشه ستارت' and DevblackW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'❍ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevblackW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'❍ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر' and DevblackW(msg) then 
...
echo '⇗ نظام التشغيل ⇖•\n*»» '"$linux_version"'*' 
echo '*ــــــــــــــــــــــ❍ـــــــــــــــــــــ~*\n❍{ الذاكره العشوائيه } ⇎\n*»» '"$memUsedPrc"'*'
echo '*ــــــــــــــــــــــ❍ـــــــــــــــــــــ~*\n❍{ وحـده الـتـخـزيـن } ⇎\n*»» '"$HardDisk"'*'
...
if text == 'تحديث السورس' and DevblackW(msg) then 
os.execute('rm -rf black.lua')
os.execute('wget https://raw.githubusercontent.com/jack1eljoker1/black22/master/black.lua')
send(msg.chat_id_, msg.id_,'❍ تم تحديث السورس \n❍ لديك اخر اصدار لسورس بلاك\n❍ الاصدار » { V²}')
dofile('black.lua')  
end
if text == 'الاصدار' and DevblackW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'❍ اصدار سورس بلاك \n❍ الاصدار »{ V²}')
end
if text == "ضع اسم للبوت" and DevblackW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"❍ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات' and DevblackW(msg) then 
...
if text == 'المشتركين' and DevblackW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n❍ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات' and DevblackW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n❍ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين") and DevblackW(msg) then
...
if text == ("قائمه العام") and DevblackW(msg) then
...
if text == ("قائمه الكتم العام") and DevblackW(msg) then
...
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DevblackW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❍ ارسل الان اذاعتك؟ \n❍ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه" and msg.reply_to_message_id_ == 0 and DevblackW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❍ ارسل الان اذاعتك؟ \n❍ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and DevblackW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❍ ارسل الان اذاعتك؟ \n❍ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and DevblackW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❍ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص" and msg.reply_to_message_id_ == 0  and DevblackW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"❍ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه' and DevblackW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين" and DevblackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف المجموعات" and DevblackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevblackW(msg) then
...
usertext = '\n❍ العضو » ['..result.title_..'](t.me/'..(username or 'BLACK_TEAM_4')..')'
status  = '\n❍ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevblackW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevblackW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevblackW(msg) then
...
if black1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'❍ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_TEAM_4')..') \n❍ '..black1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevblackW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevblackW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevblackW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '❍ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevblackW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '❍ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❍ " and DevblackW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "❍ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❍ $") and DevblackW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '❍ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❍ " and DevblackW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❍ " and DevblackW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "❍ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❍ " and DevblackW(msg) then  
...
bnnaGet(msg.sender_user_id_, V_P_E_name)
end
...
function amir_blacka_new(black1,black2)
if black2 and black2.first_name_ then 
if black2.first_name_:match("(.*)"..database:get(bot_id.."black:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."black:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local black_nnn = database:get(bot_id.."black:nump"..msg.chat_id_) or 5
local black_nnn2 = database:get(bot_id.."black:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(black_nnn2) == tonumber(black_nnn) or tonumber(black_nnn2) > tonumber(black_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."black:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❍ عزيزي >>["..black2.username_.."](https://t.me/"..(black2.username_ or "BLACK_TEAM_4")..")\n❍ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."black:teh"..msg.chat_id_).."} بجانب اسمك\n❍ عدد المحاولات المتبقيه {"..(tonumber(black_nnn) - tonumber(black_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_blacka_new)
end
end
...
send(msg.chat_id_, msg.id_, "القمر حذف صورو ليه ؟")
...
❍ 𝐷𝐸𝑉 >> [˹ 𝐽𝐴𝐶𝐾 .](t.me/V_P_E)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ 
❍ 𝐷𝐸𝑉 >> [˹ 𝐸𝐿 𝐽𝑂𝐾𝐸𝑅 .](t.me/A_j_o_k_e_r)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝐷𝐸𝑉 >> [˹ 𝐴𝐷𝐻𝐴𝑀 .](t.me/Q_Y_4)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ـــ❍ >> [˹ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 .](t.me/BLACK_TEAM_4)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ـــ❍>> [˹ 𝑇𝑂 𝑇𝐴𝐿𝐾 𝐹𝑂𝑅 𝑈𝑆 .](t.me/BB00OT_BoT)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevblackW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevblackW(msg) then    
dofile('black.lua')  
send(msg.chat_id_, msg.id_, '❍ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevblackW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevblackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, "❍ لا تستطيع كتم او حظر او تقييد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1424388256) then  
send(msg.chat_id_, msg.id_, "❍  لا تستطيع كتم او حظر او تقييد البابا جاك")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1317966118) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع كتم او حظر او تقييد المبرمج الجوكر")
return false 
end
...
if text and text:match("^حظر عام @(.*)$")  and DevblackW(msg) then
...
if tonumber(result.id_) == tonumber(1317966118) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع حظر او كتم او طرد المبرمج الجوكر")
return false 
end

if tonumber(result.id_) == tonumber(1424388256) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع حظر او كتم او طرد البابا جاك")
return false 
end

if tonumber(result.id_) == tonumber(1488653639) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع حظر او كتم او طرد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevblackW(msg) then
...
if tonumber(userid) == tonumber(1317966118) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع كتم او حظر او تقييد المبرمج الجوكر")
return false 
end
if tonumber(userid) == tonumber(1424388256) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع كتم او حظر او تقييد البابا جاك")
return false 
end
if tonumber(userid) == tonumber(1488653639) then  
send(msg.chat_id_, msg.id_, "❍ لا تستطيع كتم او حظر او تقييد 𝙳𝙴𝚅 𝙰𝙳𝙷𝙰𝙼 🇪🇬")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevblackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevblackW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevblackW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevblackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevblackW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevblackW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevblackW(msg) then
...
if database:get(bot_id.."V_P_E:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'V_P_E:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."V_P_E:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'V_P_E:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevblackW(msg) then
t = '❍ ملفات السورس بلاك ↓\n 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ² \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://https://raw.githubusercontent.com/jack1eljoker1/Files_Black/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/Files_Black/master/File_Bot/"..file)
if res == 200 then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevblackW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevblackW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
st = https.request('https://Boyka-source.tk/BoykaTeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://Boyka-source.tk/BoykaTeAM/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text == 'جاك' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/V_P_E) ') 
return false
end

if text == 'الجوكر' then 
send(msg.chat_id_,msg.id_, ' [مطور السورس.](http://t.me/A_j_o_k_e_r) ') 
return false
end

if text == 'ادهم' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/Q_Y_4) ') 
return false
end
...
local  statuss  = '\n❍ تم رفع العضو حمار الجروب \n❍ تعال حبي استلم الكارو '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
status  = '\n❍ تم تنزيل العضوه وتكه من المجموعه\n❍ كفايه اسناب يا ظالمه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, '❍ تم تنزيل جميع خولات الجروب')
end
...
send(msg.chat_id_, msg.id_, '❍ تم تنزيل جميع كلاب المجموعة ')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❍ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'
local  statuss  = '\n❍ تم رفع العضو كلب بالجروب\n❍ تعال يا بوبي خدلك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == 'مسح كليشه المطور' and DevblackW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'❍ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevblackW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n❍ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..'\n❍ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevblackW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevblackW(msg) then  
...
if text == 'تفعيل البوت الخدمي' and DevblackW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevblackW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if not database:get(bot_id..'V_P_E:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'V_P_E:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if database:get(bot_id..'Bc:Bots') and not DevblackW(msg) then 
...
if text == ("مسح ردود المطور") and DevblackW(msg) then 
...
if text == ("ردود المطور") and DevblackW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n❍ قائمة ردود المطور \n 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ²\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevblackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and DevblackW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevblackW(msg) then   
...
if text == 'تعطيل المغادره' and DevblackW(msg) then  
...
send(msg.chat_id_, msg.id_,'❍ داخل عبر الرابط وبيسأل 😒') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'❍ تم تعطيل امر مين ضافنؤ') 
end
end
...
Text = '❍ مين ضافني مفعله بالمجموعة مسبقا '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == ("ايدي")  or text == 'id' or text == 'ID'  or text == 'Id' and msg.reply_to_message_id_ == 0 and not database:get(bot_id..'Bot:Id'..msg.chat_id_) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'استعاده الاوامر' and DevblackW(msg) then
...
Text = [[
❍「مرحباً بك في اوامر البوت 」•
                     
❍ م1 ➢ أوامر الحمايه
❍ م2 ➢ أوامر تعطيل ~ تفعيل
❍ م3 ➢ أوامر ضع ~ اضف
❍ م4 ➢ أوامر مسح ~ حذف
❍ م5 ➢ أوامر تنزيل+رفع+التغير
❍ م6 ➢ أوامر الجروب
❍ م7 ➢ أوامر التحشيش
❍ م8 ➢ أوامر مطور البوت
❍ م9 ➢ أوامر المطور الاساسي 
❍ م10 ➢ أوامر الأعضاء
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ❍
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
...
send(msg.chat_id_, msg.id_, t..'ٴ❍  𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 ²❍○ٴ\n❍ [[˹ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐿𝐴𝐶𝐾 .](http://t.me/BLACK_TEAM_4)](t.me/BLACK_TEAM_4)➢ ')
end
...
------------------------------------------------------------------------
local revorb0t = database:get(bot_id.."black1:Add:Filter:Rp2"..text..result.chat_id_)   
if revorb0t then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"❍ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n❍ ["..revorb0t.."] \n") 
